...
| <a name="input_consumer_mode"></a> [consumer\_mode](#input\_consumer\_mode) | real\_time (SNS->Lambda push) \| near\_real\_time (drain) \| batch (drain, cron) \| external (caller manages the trigger). | `string` | `"near_real_time"` | no |
